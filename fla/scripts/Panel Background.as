...
p.update = function()
{
   var _loc2_ = this.createEmptyMovieClip("backgroundMC",1);
   _loc2_.lineStyle(this.borderThickness,this.borderColor);
   _loc2_.beginFill(this.backgroundColor);
   _loc2_.moveTo(0,0);
   _loc2_.lineTo(this.width,0);
   _loc2_.lineTo(this.width,this.height);
   ...
   var _loc4_ = this.displayText(this.title,{depth:2,vAlign:"top",hAlign:"left",x:this.xMargin,y:this.yMargin,embedFonts:true,textFormat:this.interfaceTextFormat});
   var _loc3_;
   if(this.showBar)
   {
      _loc3_ = this.yMargin + this.barYOffset + _loc4_._height / 2;
      _loc2_.lineStyle(this.barThickness,this.barColor);
      _loc2_.moveTo(2 * this.xMargin + _loc4_.textWidth,_loc3_);
      _loc2_.lineTo(this.width - this.xMargin,_loc3_);
   }
};
